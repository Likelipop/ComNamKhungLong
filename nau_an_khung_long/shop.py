...
SHOP_TIPS = [
    ...
    {"id": "tip_3", "name": "Bữa ăn hạnh phúc", "price": 100, "desc": "Công thức đắt giá nhất nhà hàng!", "content": "Trước tiên nướng thịt (🥩+🔥). Sau đó lấy 🍖 (Thịt nướng) + 😃 + 🌶️ = 🍛 (Cà ri vui vẻ) bán được tận 80 đồng!"},
]
